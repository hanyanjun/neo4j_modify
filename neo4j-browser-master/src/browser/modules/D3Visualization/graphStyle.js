...
export default function neoGraphStyle () {
  // 修改默认的样式
  const defaultStyle =
  {"node":{"diameter":"10px","color":"#57C7E3","border-color":"#23b3d7","border-width":"2px","text-color-internal":"#FFFFFF","font-size":"10px"},"relationship":{"color":"#A5ABB6","shaft-width":"1px","font-size":"8px","padding":"3px","text-color-external":"#000000","text-color-internal":"#FFFFFF","caption":"<type>"},"node.*":{"color":"#C990C0","border-color":"#b261a5","text-color-internal":"#FFFFFF","defaultCaption":"<id>"},"node.Block123":{"color":"#F16667","border-color":"#eb2728","text-color-internal":"#FFFFFF","defaultCaption":"<id>","caption":"{name}"},"node.Icomarks":{"defaultCaption":"<id>"},"node.Messari":{"color":"#ECB5C9","border-color":"#da7298","text-color-internal":"#604A0E","defaultCaption":"<id>","caption":"{name}"},"node.Organization":{"color":"#8DCC93","border-color":"#5db665","text-color-internal":"#604A0E","defaultCaption":"<id>"},"node.Project":{"color":"#4C8EDA","border-color":"#2870c2","text-color-internal":"#FFFFFF","defaultCaption":"<id>","diameter":"65px","caption":"{name}"},"node.Sector":{"color":"#DA7194","border-color":"#cc3c6c","text-color-internal":"#FFFFFF","defaultCaption":"<id>","diameter":"80px"},"node.Capital":{"color":"#57C7E3","border-color":"#23b3d7","text-color-internal":"#FFFFFF","defaultCaption":"<id>"},"node.Twitter":{"color":"#C990C0","border-color":"#b261a5","text-color-internal":"#FFFFFF","defaultCaption":"<id>","diameter":"10px"},"node.Token":{"color":"#F79767","border-color":"#f36924","text-color-internal":"#FFFFFF","defaultCaption":"<id>","diameter":"50px"},"node.Person":{"color":"#C990C0","border-color":"#b261a5","text-color-internal":"#FFFFFF","defaultCaption":"<id>","caption":"{name}","diameter":"50px"},"node.Facebook":{"defaultCaption":"<id>","diameter":"10px","color":"#C990C0","border-color":"#b261a5","text-color-internal":"#FFFFFF"},"node.Github":{"defaultCaption":"<id>","color":"#C990C0","border-color":"#b261a5","text-color-internal":"#FFFFFF"},"node.Instagram":{"defaultCaption":"<id>"},"node.Linkedin":{"defaultCaption":"<id>","color":"#C990C0","border-color":"#b261a5","text-color-internal":"#FFFFFF"},"node.Medium":{"defaultCaption":"<id>","color":"#C990C0","border-color":"#b261a5","text-color-internal":"#FFFFFF","diameter":"10px"},"node.Pencil":{"defaultCaption":"<id>","color":"#C990C0","border-color":"#b261a5","text-color-internal":"#FFFFFF"},"node.Tech":{"defaultCaption":"<id>","color":"#D9C8AE","border-color":"#c0a378","text-color-internal":"#604A0E"},"node.Website":{"defaultCaption":"<id>","color":"#D9C8AE","border-color":"#c0a378","text-color-internal":"#604A0E"},"node.Whitepaper":{"defaultCaption":"<id>","color":"#D9C8AE","border-color":"#c0a378","text-color-internal":"#604A0E"},"node.Wikipedia":{"defaultCaption":"<id>"},"node.Youtube":{"defaultCaption":"<id>","color":"#C990C0","border-color":"#b261a5","text-color-internal":"#FFFFFF"}}
  const defaultSizes = [
    {
      diameter: '10px'
    },
